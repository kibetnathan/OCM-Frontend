            ...
            {chapterData && !loadingChapter && (
              <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                  ...
                  <h1 className="font-cormorant text-4xl font-light text-stone-800">
                ...
                <div className="flex items-center justify-between mt-12 pt-6 border-t border-stone-200">
                  <button
                    ...
                    className="flex items-center gap-2 font-coptic text-[0.6rem] uppercase tracking-widest text-stone-400 hover:text-amber-600 disabled:opacity-20 disabled:cursor-not-allowed transition-colors border border-stone-200 hover:border-amber-300 disabled:hover:border-stone-200 px-4 py-2"
                  >
