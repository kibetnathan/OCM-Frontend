    ...
    <li>
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs tracking-widest uppercase transition-all duration-200 border-l-2 border-transparent ${
          open ? "text-stone-200 bg-white/4" : "text-stone-400 hover:bg-white/5 hover:text-stone-100"
        }`}
      >
        {icon}
        {label}
...
function Sidebar() {
  ...
  const myFellowships = fellowships.filter((g) => g.members?.includes(user?.id));
          ...
          {isLeader && (
            <>
              ...
              >
                ...
                <li><NavLink to="/dashboard/groups/departments" className={subLinkClass}>Serving Departments</NavLink></li>
                <li><NavLink to="/dashboard/groups/serving-teams" className={subLinkClass}>Services & Equipment</NavLink></li>
              </ExpandableSection>
              ...
              >
                <li><NavLink to="/dashboard/users" className={subLinkClass}>All Members</NavLink></li>
                <li><NavLink to="/dashboard/users/roles" className={subLinkClass}>Roles</NavLink></li>
              </ExpandableSection>
            </>
          )}
          ...
          >
            ...
            {myFellowships.length > 0 ? (
              myFellowships.map((group) => (
                <li key={group.id}>
                  <NavLink to={`/messages/group/${group.id}`} className={subLinkClass}>
                    # {group.name}
                  </NavLink>
                </li>
              ))
